...
while(true)
    ...
    while(true)
        ...
        if seed == newseed || j>1 %5 % Condition for convergence and maximum iteration.
            j=0;
...
intercluster = (max(gray(:)/100)); %10 % Findout Minimum distance between two cluster Centers.
